...
import com.example.baseapp.navigation.ADD_DATA_URL
import com.example.baseapp.navigation.LOGIN_URL
import com.example.baseapp.navigation.VIEW_DATA_URL
import com.example.baseapp.ui.theme.BaseAppTheme
import com.example.baseapp.ui.theme.NewBlue

@SuppressLint("UnusedMaterial3ScaffoldPaddingParameter")
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun ViewDataScreen(navController:NavHostController){
    Column(
            ...
            topBar = {
                ...
                TopAppBar(title = { Text(text = "PropertyPulse", color = Color.White, fontWeight = FontWeight.ExtraBold) },
                    ...
                    navigationIcon = { }, actions = {
                        IconButton(onClick = { navController.navigate(ADD_DATA_URL) }) {
                ...
                Column(
                    ...
                    )
                    {
                        ...
                        Card(modifier = Modifier
                            ...
                            .width(200.dp)
                            .height(110.dp)
                            .clickable { navController.navigate(VIEW_DATA_URL) }
                        ) {
